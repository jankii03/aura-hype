...
export const Route = createFileRoute("/brands/tory-burch/")({
	component: ToryBurchPage,
	loader: async ({ context }) => {
		if (isCloudflare()) {
			return;
		}
		await context.queryClient.prefetchQuery(
			context.trpc.products.list.queryOptions({ brand: "Tory Burch" }),
		);
	},
});

function ToryBurchPage() {
