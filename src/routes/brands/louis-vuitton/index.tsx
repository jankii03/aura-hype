...
function LouisVuittonPage() {
	...
	const { data } = useQuery(
		trpc.products.list.queryOptions({ brand: "Louis Vuitton", ...(genderFilter && { gender: genderFilter }) }),
	);
	...
	return (
		<div className="min-h-screen text-white relative">
			...
			{isMenuOpen && (
				...
				>
					<div
						className="absolute left-0 top-0 h-full w-80 bg-white text-black overflow-y-auto shadow-2xl"
